...
public class CurrencyRatesStorageTest {
    ...
    public void testGetAllRates(){
        assertEquals(currencyData,storage.getAllRates());
    }
    ...
    public void testGetRatesForRUB(){
        ...
        assertEquals(rubMap, storage.getRatesForCode("RUB"));
    }
    ...
    public void testGetBuyPricesForEur(){
        ...
        assertEquals(eurMap, storage.getBuyPriceForCode("EUR"));
    ...
    public void testGetSellPricesForUSD(){
        ...
        assertEquals(usdMap, storage.getSellPricesForCode("USD"));
    }
    ...
    public void testGetBestPropositions(){
        ...
        assertEquals(report, storage.getBestPropositions());
    }
